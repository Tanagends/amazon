...
{   
      name = 'Quality Hair Straightners',
      category = 'Electronics'
...
{   
      ...
      category = 'Electronics'
      imageUrl = 'https://rukminim2.flixcart.com/image/612/612/xif0q/headphone/y/2/z/zeb-thunder-pro-wireless-zebronics-original-imag5qkmzqusmnsh.jpeg?q=70',
      flipkartLink = 'https://fktr.in/m5b7V4I',
      rating = 4.7,
      reviewCount = 444,
    },
...
{   
      name = 'Men Striped Round Neck Cotton Blend Maroon T-Shir',
      category = 'Fashion'
...
{   
      name = 'Quality cheap snikers for men',
      category = 'Fashion'
...
{  
    	...
    	
     {
      ...
      name = 'Nothing best noise councelling earpords ',
      category = 'Electronics',
    	...
    	
     {
      ...
      name = 'Quality Formal shoes for men ',
      category = 'Fashion',
      imageUrl =  'https://rukminim2.flixcart.com/image/612/612/xif0q/shoe/g/2/7/8-aj-patent-8-ajniha-tan-original-imah4fehpnb8xyed.jpeg?q=70' ,
      flipkartLink =  'https://fktr.in/h7YT54E ' ,
      rating = 4.6,
      reviewCount = 6634,
