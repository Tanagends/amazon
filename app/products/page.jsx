...
import importedProducts from '../../components/ten-products'; // Import the updated products
...
export default function ProductsPage() {
  // Transform products: update amazonLink to imageUrl and remove price/oldPrice
  const productsToShow = importedProducts.map(p => {
    const { price, oldPrice, ...rest } = p; // Destructure to remove price and oldPrice
    return {
      ...rest,
      amazonLink: p.imageUrl, // Set amazonLink to imageUrl
    };
  });
